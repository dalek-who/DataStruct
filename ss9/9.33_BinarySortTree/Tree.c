...
int CreatTree(Tree tree,Tree_Elemtype data){
    ...
    printf("input %d's children left rignt:");scanf("%d %d",&ldata,&rdata);
...
//////////////////////////////////////////////////////////////////////////////////
//插入结点
Tree InsertNode(Tree_Elemtype node){
    Tree tree=NULL;
    tree = InitTree();
    tree->data = node;
    return tree;
...
Tree oj_InsertNode(int node, Tnode TreeArray[]){
    Tree tree=NULL;
    if( node== 0)
        return NULL;
    else{
        ...
        tree->left =oj_InsertNode(TreeArray[node].left,TreeArray);
        tree->right=oj_InsertNode(TreeArray[node].right,TreeArray);
    }
...
Tree oj_CreatTree(){
    ...
    //创建树形树
    tree = oj_InsertNode(1,TreeArray);
    return tree;
}
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////